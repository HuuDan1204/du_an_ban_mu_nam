...
<option value="<?php echo $updateBinhLuanDetail['san_pham_id']  ?>" selected><?php echo $updateBinhLuanDetail['ten_san_pham']  ?></option> 
<?php
...
?>
  ...
  <div class="mb-3">
      ...
      <option   value="<?php echo $updateBinhLuanDetail['tai_khoan_id']  ?>" selected><?php echo $updateBinhLuanDetail['ho_ten']  ?></option> 
        <?php
        $conn = new mysqli("localhost", "root", "", "du_an_ban_mu_nam");
  ...
  <div class="mb-3">
      ...
      <?php echo trim($updateBinhLuanDetail['noi_dung']); ?>
      </textarea>
  </div>
  ...
  <div class="mb-3">
      ...
      <?php
        ...
        ?>
      <input type="date" class="form-control" value="<?php echo $updateBinhLuanDetail['ngay_dang']; ?>" id="ngay_dang" name="ngay_dang" required>
  </div>

  <div class="mb-3">
      <label for="trang_thai" class="form-label">Trạng Thái</label>
      <select class="form-control" id="trang_thai" name="trang_thai" required>
    <option value="0" <?php echo ($updateBinhLuanDetail['trang_thai'] == 0) ? 'selected' : ''; ?>>Chưa duyệt</option>
    <option value="1" <?php echo ($updateBinhLuanDetail['trang_thai'] == 1) ? 'selected' : ''; ?>>Đã duyệt</option>
</select>
  </div>
