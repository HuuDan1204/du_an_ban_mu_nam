<?php include './views/layouts/header.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <option value="" selected disabled>-- Mời bạn chọn Tên sản phẩm  --</option> 
        <?php
        ...
        ?>
            ...
            <div class="mb-3">
                ...
                <option value="" selected disabled>-- Mời bạn chọn Tên Tài Khoản  --</option> 
                  <?php
                  $conn = new mysqli("localhost", "root", "", "du_an_ban_mu_nam");
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="noi_dung" name="noi_dung" rows="4" placeholder="Nhập nội dung tại đây..." required></textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <?php
                  ...
                  ?>
                <input type="date" class="form-control" value="<?php echo $current_date; ?>" id="ngay_dang" name="ngay_dang" required>
            </div>
