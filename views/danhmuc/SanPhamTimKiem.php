            ...
            <?php foreach($SanPham as $item) { ?>
                <div class="product__discount__item">
                    <div class="product__discount__item__pic set-bg">
                        ...
                        <?php if (!empty($item['gia_khuyen_mai'])): ?>
                            <div class="product__discount__percent">
                                -<?= round((($item['gia_san_pham'] - $item['gia_khuyen_mai']) / $item['gia_san_pham']) * 100) ?>%
                            </div>
                        <?php endif; ?>
                        <ul class="product__item__pic__hover">
                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
                            <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                            <li><a href="<?= BASE_URL . '?act=them-gio-hang&id_san_pham=' . $item['id'] ?>">
                    ...
                    <div class="product__discount__item__text">
                        <span>Giảm sốc</span>
                        <h5><a href="#"><?= $item['ten_san_pham'] ?></a></h5>
                        <?php if (!empty($item['gia_khuyen_mai'])): ?>
                            <div class="product__item__price">
                                <?= number_format($item['gia_khuyen_mai'], 0, ',', '.') ?>VND 
                                <span><?= number_format($item['gia_san_pham'], 0, ',', '.') ?>VND</span>
                            </div>
                        <?php else: ?>
                            <div class="product__item__price">
